...
:enseignant: Nicole Raulf qui a tout copié chez Jean-François Burnol
:groupe: SESI 12
...
def solve_linear_equation(a, b, c):
    ...
    assert not(b==0 and a==0) , "L'un de a ou b doit être non nul !"
    
    donee = pgcd_étendu(a,b)
...
def chiffre_message_affine_tp3(msg, cle, alphabet=ALPHABETS['CAPITAL_LATIN']):
    ...
    for i in range(len(msg)):
        if msg[i] == " " :
            ...
            res += chiffre_lettre_affine_tp3(msg[i], cle, alphabet)
