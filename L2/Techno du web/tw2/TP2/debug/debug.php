...
print(elementBuilder('h2','La marque du diable','titre')."\n");

print(authorsToHTML('Marini - Desberg')."\n");

print(coverToHTML('scorpion.jpg')."\n");

print(propertyToHTML('titre', 'La marque du diable')."\n");

print(propertyToHTML('auteurs', 'Marini - Desberg')."\n");

$dl = new FileBookReader('../data/livres.txt');

print(libraryToHTML($dl));
