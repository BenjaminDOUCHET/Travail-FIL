...
int main(int argc, char **argv) {
  ...
  if (strcmp(argv[1], "repeat3") == 0) {
    ...
    transposed_control_matrix()
   } 
  else if (strcmp(argv[1], "repeat3-linear") == 0) {
    linear_encoding(transposed_control_matrix(repeat3_generator(argv[2])));
  } 
  else if (strcmp(argv[1], "parity2d") == 0) {
    linear_encoding(transposed_control_matrix(parity2d_generator()));
  } 
  else if (strcmp(argv[1], "hamming") == 0) {
     linear_encoding(transposed_control_matrix(hamming_generator()));
  } 
  else if (strcmp(argv[1], "hammingp") == 0) {
    linear_encoding(transposed_control_matrix(hammingp_generator()));
  }  
  else {
